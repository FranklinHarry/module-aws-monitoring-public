...
If you're already a Gruntwork customer, the original source for this file is at: <https://github.com/gruntwork-io/module-aws-monitoring/blob/master/examples/alb-alarms/README.md>.
If you're not a customer, contact us at <info@gruntwork.io> or <http://www.gruntwork.io> for info on how to get access!

# ALB Alarms

This is an example of how to set up alarms for an Application Load Balancer (ALB) using the following modules:

* [alb-alarms](/modules/alarms/alb-alarms): A set of ALB alarms that go off if there are a surge in connections, any 
client TLS negotiation errors, too many 4xx or 5xx errors, or more requests than your ALB can handle.
