...
If you're already a Gruntwork customer, the original source for this file is at: <https://github.com/gruntwork-io/module-aws-monitoring/blob/master/examples/elasticache-alarms/README.md>.
If you're not a customer, contact us at <info@gruntwork.io> or <http://www.gruntwork.io> for info on how to get access!

# ElastiCache Alarms Example

This is an example of how to set up alarms for an ElastiCache cluster using the following modules:

* [elasticache-alarms](/modules/alarms/elasticache-alarms): Alarms for an ElastiCache cluster that go off if the CPU
  usage or memory usage get too high.
