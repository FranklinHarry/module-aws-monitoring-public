...
If you're already a Gruntwork customer, the original source for this file is at: <https://github.com/gruntwork-io/module-aws-monitoring/blob/master/examples/elb-alarms/README.md>.
If you're not a customer, contact us at <info@gruntwork.io> or <http://www.gruntwork.io> for info on how to get access!

# ELB Alarms

This is an example of how to set up alarms for an Elastic Load Balancer (ELB) using the following modules:

* [elb-alarms](/modules/alarms/elb-alarms): A set of ELB alarms that go off if the latency gets too high, or there are
