...
If you're already a Gruntwork customer, the original source for this file is at: <https://github.com/gruntwork-io/module-aws-monitoring/blob/master/modules/alarms/ecs-cluster-alarms/README.md>.
If you're not a customer, contact us at <info@gruntwork.io> or <http://www.gruntwork.io> for info on how to get access!

# ECS Cluster Alarms Module

This module can be used to create CloudWatch alarms that go off if the CPU or memory usage gets too high for an entire
