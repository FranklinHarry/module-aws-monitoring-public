...
If you're already a Gruntwork customer, the original source for this file is at: <https://github.com/gruntwork-io/module-aws-monitoring/blob/master/modules/alarms/elasticache-memcached-alarms/README.md>.
If you're not a customer, contact us at <info@gruntwork.io> or <http://www.gruntwork.io> for info on how to get access!

# ElastiCache Memcached Alarms Module

This module adds alarms for metrics produced by an [ElastiCache Cluster](https://aws.amazon.com/elasticache/) that is
running [memcached](https://memcached.org/). These alarms will go off if the CPU usage or memory usage gets too high.
