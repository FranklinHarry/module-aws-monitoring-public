...
If you're already a Gruntwork customer, the original source for this file is at: <https://github.com/gruntwork-io/module-aws-monitoring/blob/master/modules/alarms/rds-alarms/README.md>.
If you're not a customer, contact us at <info@gruntwork.io> or <http://www.gruntwork.io> for info on how to get access!

# RDS Alarms Module

This module adds alarms for metrics produced by an [Relational Database Service (RDS) DB](https://aws.amazon.com/rds/).
They will go off if the CPU usage, number of connections, or latency gets too high or if the available memory or disk
space gets too low.

## How do you use this module?

Check out the [examples/rds-alarms example](/examples/rds-alarms).
